...
INSERT INTO "new_Scenario" ("capex", "debtInterestRate", "debtMaturityYears", "debtRate", "degradationRate", "discountRate", "dscr", "id", "irr", "isReference", "lcoe", "name", "npv", "opex", "projectId", "projectLifeYears", "tariff", "yieldMwh") SELECT "capex", "debtInterestRate", "debtMaturityYears", "debtRate", "degradationRate", "discountRate", "dscr", "id", "irr", "isReference", "lcoe", "name", "npv", "opex", "projectId", "projectLifeYears", "tariff", "yieldMwh" FROM "Scenario";
DROP TABLE "Scenario";
