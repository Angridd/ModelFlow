...
function readScenarioAssumptions(formData: FormData) {
  return {
    ...
    constructionYears: readOptionalInteger(formData, "constructionYears"),
    ...
    iferRate1: readOptionalNumber(formData, "iferRate1"),
    iferRate2: readOptionalNumber(formData, "iferRate2"),
    iferRpn: readOptionalNumber(formData, "iferRpn"),
    inflationAurora: readOptionalNumber(formData, "inflationAurora"),
    ...
    margeFactAmortissableKeuro: readOptionalNumber(formData, "margeFactAmortissableKeuro"),
